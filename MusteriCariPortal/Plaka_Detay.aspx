<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="Plaka_Detay.aspx.cs" Inherits="MusteriCariPortal.Plaka_Detay" %>
<!DOCTYPE html>
   ...
   <div id="mainContainer" class="container">               
    ...
    <div>
       <br/>
        ...
        <asp:GridView ID="grdFatura" runat="server" CssClass="table table-striped table-bordered table-hover"  CellPadding="2" ForeColor="#333333" GridLines="None" style="text-align:right" ShowFooter="True" Width="100%" BorderStyle="None">
    ...
    <div>
       <br/>
        ...
        <div class="table-responsive">
        <asp:GridView ID="grd1" runat="server" CssClass="table table-striped table-bordered table-hover"  CellPadding="2" ForeColor="#333333" GridLines="None" style="text-align:right" ShowFooter="True" Width="100%" BorderStyle="None">
            <AlternatingRowStyle BackColor="White" />
            <FooterStyle BackColor="Gainsboro" Font-Bold="True" ForeColor="Black" />
            <HeaderStyle BackColor="Gainsboro" Font-Bold="True" ForeColor="ActiveCaptionText" />
            <PagerStyle BackColor="WhiteSmoke" ForeColor="#333333" />
